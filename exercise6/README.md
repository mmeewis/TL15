...
The Adobe Campaign instance we use in this demo, sends all emails to a sandbox environment. You can access this environment via this [web based email client](https://marcmeewis-230217.campaign-demo.adobe.com/webmail/?_task=mail&_mbox=INBOX). Login with user "demo" and password "". The email client will show all mails send during this lab. Make sure that you open your own email. Your mail will have a subject beginning with your "machine label" CSxx-xxx that you entered as part of the form data.
